/*
  ...
  - You are about to drop the column `phone_nomber` on the `clients` table. All the data in the column will be lost.
...
INSERT INTO "new_clients" ("createdAt", "email", "id", "name", "updatedAt") SELECT "createdAt", "email", "id", "name", "updatedAt" FROM "clients";
DROP TABLE "clients";
